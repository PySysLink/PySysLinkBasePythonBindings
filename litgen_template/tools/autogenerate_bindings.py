...
def my_litgen_options() -> litgen.LitgenOptions:
    ...
    options.fn_namespace_vectorize__regex = r"^PySysLinkBase::MathFunctions$"  # Do it in this namespace only
...
def autogenerate() -> None:
    ...
    header_files = [include_dir + "PySysLinkBase/PySysLinkBase.h"]
