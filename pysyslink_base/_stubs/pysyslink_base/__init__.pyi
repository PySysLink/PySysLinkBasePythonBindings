...
class ISimulationBlockWithContinuousStatesPython(ISimulationBlockWithContinuousStates):
    def get_continuous_states(self) -> List[float]:  # overridable
        pass

    def set_continuous_states(self, new_states: List[float]) -> None:  # overridable
        pass

    def get_continous_state_derivatives(  # overridable
